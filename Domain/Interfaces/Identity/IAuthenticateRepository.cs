...
public interface IAuthenticateRepository
{
    ...
    Task LogoutAsync();
    Task<(bool success, string errorMessage)> UpdateProfileAsync(string email, string firstName, string lastName, string phone, DateTime birthDate, bool iSSubscribedToNewsletter);
